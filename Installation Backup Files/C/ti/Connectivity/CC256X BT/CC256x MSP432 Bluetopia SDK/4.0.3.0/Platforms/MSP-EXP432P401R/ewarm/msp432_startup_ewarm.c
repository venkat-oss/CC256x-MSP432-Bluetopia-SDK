...
//
//*****************************************************************************
extern void CTS_Port_ISR(void);
extern void SysTick_ISR(void);
extern void Debug_UART_eUSCI_A_ISR(void);
extern void HCI_UART_eUSCI_A_ISR(void);
...
//*****************************************************************************
   ...
   #define SYSTEM_STACK_SIZE 4000
#endif
static uint32_t systemStack[SYSTEM_STACK_SIZE / sizeof(uint32_t)] @ ".noinit";
